...
{
    public static async Task SeedInitialDataAsync(IUnitOfWork unitOfWork, ILogger logger)
    {
        await PermissionDiscoveryService.DiscoverAndSyncPermissionsAsync(unitOfWork, typeof(DbInitializer).Assembly, logger);
